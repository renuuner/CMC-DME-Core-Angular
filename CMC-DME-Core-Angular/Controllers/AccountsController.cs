...
namespace CMC_DME_Core_Angular.Controllers
{
  ...
  public class AccountsController : ControllerBase
  {
    ...
    // GET: api/Accounts
    [HttpGet]
    public async Task<ActionResult<IEnumerable<Account>>> GetAccountDetails()
    {
      var accountsList = await _context.AccountDetails.ToListAsync();
      return accountsList.OrderByDescending(a => a.AccountId).ToList();
    }
